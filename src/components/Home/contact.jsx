...
function Contact() {
    return (
        <div style={{ background: "linear-gradient(174deg, rgba(14,57,123,1) 0%, rgba(0,102,255,1) 51%, rgba(44,157,227,1) 100%)" }} className='text-[#FFFFFF] h-auto'>
            <div className='flex flex-col justify-center gap-3 pt-20 ' data-aos="fade-up">
            ...
            <div className='lg:flex  md:flex md:flex-row md:justify-around lg:justify-around lg:gap-20 lg:h-[450px] xl:items-start lg:mt-5 '>
                <div className='xl:text-sm lg:mt-5' data-aos="fade-up">
                ...
                <form className='mt-4 mx-4  xl:mt-9 xl:text-sm w-fit lg:w-[38%] md:h-96 h-[410px] ' data-aos="fade-up">
                    <ul className='flex flex-col gap-4 lg:flex lg:flex-col lg:gap-3 xl:flex xl:justify-center '>
                        <div className='lg:flex lg:flex-row lg:gap-2 md:flex md:gap-2 w-full flex flex-col gap-4 '>
                            {datas.slice(0, 2).map((item, index) => (
                                <li key={index} className='w-full lg:w-1/2 '>
                                    <input
                                        className='px-3 py-3 lg:py-4 rounded-sm text-xs text-black w-full xl:text-[13px] '
                                        placeholder={item}
                                    />
                                </li>
                            ))}
                        ...
                        {datas.slice(2).map((item, index) => (
                            <li key={index + 2} className='w-full '>
                                <input
                                    className='px-3 py-3  rounded-sm text-xs text-black w-full xl:text-sm '
                                    placeholder={item}
                                />
                            </li>
                        ))}
                    ...
                    <textarea placeholder='write you inquiry here' className=' pb-16 pr-4 pt-2 pl-2 text-black w-full my-5 lg:my-3 rounded-lg text-xs xl:text-sm' />
