...
function Contact() {
    return (
        <div style={{background: "linear-gradient(174deg, rgba(14,57,123,1) 0%, rgba(0,102,255,1) 51%, rgba(44,157,227,1) 100%)"}} className='text-[#FFFFFF] h-auto'>
            ...
            <div className='lg:flex  md:flex md:justify-around lg:justify-around lg:gap-20 lg:h-[400px] xl:items-start lg:mt-5'>
            <div className='xl:text-sm lg:mt-5'>
                ...
                <a href='#' className='text-[13px] underline xl:text-base lg:mx-4'>Get Direction</a>
            </div>

            <form className='mt-4 mx-4  xl:mt-9 xl:text-sm w-[38%]'>
  ...
  {datas.slice(2).map((item, index) => (
    <li key={index + 2} className='w-full'>
      ...
      />
                ...
                <input type='submit' value='Request Now' className='border-2 bg-[#212529] px-6 py-3 border-none text-[#FFFFFF] mt-4 rounded-sm'/>                
            </form>
            </div>
        </div>
    )
