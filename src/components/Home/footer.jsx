...
function Footer() {
    ...
    return (
        <div className='bg-black px-4 text-white p-6 lg:px-16'>
            <div className='lg:flex flex-row justify-center'>
                <div>
            <img src={logo} className='w-40 lg:w-44 lg:h-12 lg:mt-4 '></img>
            <div className='text-[14px] mt-4 lg:w-2/3'>Best IT Solutions & Technology WordPress
            ...
            <div className='flex flex-col gap-3 my-5'>
                ...
                <div className='flex gap-3 '><FaTwitter className='bg-gray rounded-full w-6 h-6 p-1' /><FaFacebookF className='bg-gray rounded-full w-6 h-6 p-1' /><FaLinkedinIn className='bg-gray rounded-full w-6 h-6 p-1' /><FaGithub className='bg-gray rounded-full w-6 h-6 p-1' /></div>
                </div>
                </div>
